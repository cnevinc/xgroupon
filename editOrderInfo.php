...
<tr><td colspan=7>+國內運費:</td><td><input type=text name=domestic_exp value='<?= $row['domestic_exp']?>'></td></tr>
...
4.<font color=red>尾款</font>資料: 無論面交,店到店,郵寄,此處都要填寫,以便對帳. 若尾款為負數,所有欄位都請填寫0, 並請於最下方"訂單備註" 註明您要將餘款1.留至下次出團 2.裝在包裝中寄回 3.完整帳號轉帳退款(需扣手續費13元)
<table border=1>
 <tr>
	<td><font color=red>匯款人(必填)</font></td> 
	<td><font color=red>匯款銀行(必填)</font></td>
...
5.請填取貨資訊<BR>
 ...
 <tr>
	...
	<td>預定面交日期(面交才填)</td> 
	<td>7-11店號&nbsp;&nbsp;<a href='http://www.google.com.tw?q=711門市' target=_blank>查店號</a></td>
	<td>(郵寄才填,務必寫郵遞區號)</td>
 ...
 <tr>
	...
	<td>如:4/15 		<input maxlength=20 name=delivery_time  size=10 value='<?php echo $row['delivery_time'];?>' > </td>
	<td>如:990433/店名				<input maxlength=14 size=10  name=delivery_store_name value='<?php echo $row['delivery_store_name'];?>'  ></td>
